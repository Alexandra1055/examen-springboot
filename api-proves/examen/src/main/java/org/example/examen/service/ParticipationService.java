...
import org.example.examen.error.BusinessRuleException;
import org.example.examen.mapper.ParticipationMapper;
import org.example.examen.repository.ParticipationRepository;
...
public class ParticipationService {
    ...
    public Participation enrollWithoutResult(EnrollAthleteDto req) {
    ...
    public org.example.examen.dto.ParticipationDto toDto(Participation p) {
